...
import io.menya.tracker.generator.primitive.PrimitiveGenerator;

public class ParametersGenerator extends ValueGenerator<Object[]> {
    ...
    public ParametersGenerator(Class...parameterTypes) {
        ...
        valueGenerators = new ValueGenerator[parameterTypes.length];
        for (int i = 0; i < parameterTypes.length; i++)
        {
            if (parameterTypes[i].isPrimitive())
                valueGenerators[i] = PrimitiveGenerator.build(parameterTypes[i]);
    ...
    @Override
    protected Object[] inverseValue(Object[] src) throws GenerateException {
        return new Object[0];
    }

    @Override
    protected Object[] addDelta(Object[] src) throws GenerateException {
        return new Object[0];
    }

    @Override
    protected Object[] singlePointCrossover(Object[] v1, Object[] v2) throws GenerateException {
        return new Object[0];
    }

    @Override
    protected Object[] uniformCrossover(Object[] v1, Object[] v2) throws GenerateException {
        return new Object[0];
    }

    @Override
    public Object[] mutate(Object[] mutant) throws GenerateException {
        ...
        try {
            ...
            throw new GenerateException("can't mutate " + mutant, e);
        }
    ...
    @Override
    public Object[] crossover(Object[] parent1, Object[] parent2) throws GenerateException {
        ...
        try {
            ...
            if (parent1 == null && parent2 == null)
                return random();
            throw new GenerateException("can't crossover "+parent1+" and "+parent2, e);
        }
